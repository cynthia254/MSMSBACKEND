...
namespace EccomerceWebsiteProject.Infrastructure.Migrations
{
    ...
    [Migration("20240710124719_additionofpaymentprocessingflow")]
    partial class additionofpaymentprocessingflow
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EccomerceWebsiteProject.Core.Models.Orders.NewOrder", b =>
                {
            ...
            modelBuilder.Entity("EccomerceWebsiteProject.Core.Models.Orders.NewShift", b =>
                {
                    b.Property<int>("ShiftID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EccomerceWebsiteProject.Core.Models.Orders.Order", b =>
                {
                    b.Property<int>("OrderID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EccomerceWebsiteProject.Core.Models.Orders.OrderData", b =>
                {
                    b.Property<int>("OrderID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EccomerceWebsiteProject.Core.Models.Orders.PaymentData", b =>
                {
                    b.Property<Guid>("PaymentNumber")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("EccomerceWebsiteProject.Core.Models.Orders.ProductData", b =>
                {
            ...
            modelBuilder.Entity("EccomerceWebsiteProject.Core.Models.PlatformUsers.MerchantEditUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EccomerceWebsiteProject.Core.Models.Products.CreateProduct.notification", b =>
                {
            ...
            modelBuilder.Entity("EccomerceWebsiteProject.Core.Models.Products.EditProduct.editProduct", b =>
                {
            ...
            modelBuilder.Entity("EccomerceWebsiteProject.Core.Models.Roles.CreateRole", b =>
                {
            ...
            modelBuilder.Entity("EccomerceWebsiteProject.Core.Models.Roles.Permissions", b =>
                {
                    ...
                    b.Property<int?>("CreateRoleRoleID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EccomerceWebsiteProject.Core.Models.Roles.RolePermission", b =>
                {
            ...
            modelBuilder.Entity("EccomerceWebsiteProject.Core.Models.Roles.Roles", b =>
                {
                    b.Property<int>("RoleID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EccomerceWebsiteProject.Core.Models.Stores.EditStore", b =>
                {
                    b.Property<int>("EditStoreID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("EditStoreID"));
            ...
            modelBuilder.Entity("EccomerceWebsiteProject.Core.Models.Orders.ProductData", b =>
                {
                    b.HasOne("EccomerceWebsiteProject.Core.Models.Orders.Order", "Order")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("EccomerceWebsiteProject.Core.Models.Roles.Permissions", b =>
                {
                    b.HasOne("EccomerceWebsiteProject.Core.Models.Roles.CreateRole", null)
                        .WithMany("Permissions")
                        .HasForeignKey("CreateRoleRoleID");

                    b.HasOne("EccomerceWebsiteProject.Core.Models.Roles.Roles", null)
                        .WithMany("Permissions")
